...
function eventListeners() {
    ...
    let conteudo = {
        ...
        text: "O Totalizador de Resumo Mensal de HIV/SIDA é um serviço online gratuito que auxilia na elaboração do resumo mensal de HIV/SIDA totalizando-o automaticamente com base nos dados preenchidos pelo usuário (Profissional de Saúde).",
